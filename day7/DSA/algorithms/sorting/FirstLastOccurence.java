...
public class FirstLastOccurence {
    ...
    public static int lastOcc(int[] arr,int key){
        ...
        while(s<=e){
            int mid=s+(e-s)/2;
            if(arr[mid]==key){
                //store the index & move to the extreme right for 1st occurence
                ans=mid;
                s=mid+1;
            }else if(arr[mid]<key){
                s=mid+1;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("First Occurence of 3 is " + f);
        System.out.println("last Occurence of 3 is " + l);
        System.out.println("total Occurence of 3 is " + t);
